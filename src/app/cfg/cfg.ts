...
const gdx2_host = process.env.HOST_BCK ||  server
const gdx2_port = process.env.PORT_BCK || "8001" 
const gdx2map_host = process.env.GDX2MAP_HOST || server
...
export const cfg = {
  ...
  gdx2_api            : `api/v1`,
  gdx2map_host_port_db_name  : `http://${gdx2map_host}:${gdx2map_port}/${gdx2map_db_name}.`,
