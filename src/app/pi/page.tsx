...
import {  getPis } from "../actions/getAll";
...
export default  function GetPi() {
    // const items : IResult = await getPis();
    const title: string  = "Отчеты  | Полезные ископаемые"
  ...
  return (
    ...
    { isLoading && <Spin tip="Получаем все Полезные ископаемые..." size="large" fullscreen/>  } 

    <div className="mt-20">
      <h1>Полезных ископаемых: <strong>{data?.count}</strong> </h1>
