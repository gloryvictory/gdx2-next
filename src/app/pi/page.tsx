...
import {  getFields, getLus, getOrgs, getPis, getSubrfs } from "../actions/getAll";
...
export default async function getPi() {
    const items : IResult = await getPis();

  return (
    <>
    <div className="mt-20">
      <h1>Полезных ископаемых: <strong>{items.count}</strong> </h1>
