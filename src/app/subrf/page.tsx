...
export default function GetSubrf() {
    // const items : IResult = await getSubrfs();
    const title: string  = "Отчеты  | Субъекты РФ"
  ...
  return (
    ...
    { isLoading && <Spin tip="Получаем все Субъекты РФ..." size="large" fullscreen/>  } 

    <div className="mt-20">
      <h1>Всего Субъектов РФ: <strong>{data?.count}</strong> </h1>
