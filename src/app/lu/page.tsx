...
import {  getLus } from "../actions/getAll";
...
export default function GetLu() {
    // const items : IResult = await getLus();
    const title: string  = "Отчеты  | ЛУ"
  ...
  return (
    ...
    { isLoading && <Spin tip="Получаем все ЛУ..." size="large" fullscreen/>  } 

    <div className="mt-20">
      <h1>Лицензионных участков: <strong>{data?.count}</strong> </h1>
