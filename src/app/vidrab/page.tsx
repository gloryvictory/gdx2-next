...
import {  getFields, getLus, getOrgs, getPis, getSubrfs, getVidRabs } from "../actions/getAll";
...
export default async function getVidRab() {
    const items : IResult = await getVidRabs();

  return (
    <>
    <div className="mt-20">
      <h1>Видов работ: <strong>{items.count}</strong> </h1>
