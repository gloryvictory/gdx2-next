...
import {  getVidRabs } from "../actions/getAll";



// export const metadata: Metadata = {
//     title: "Отчеты | Виды работ",
// };
...
export default  function GetVidRab() {
    // const items : IResult = await getVidRabs();
    const title: string  = "Отчеты  | Вид работ"
  ...
  return (
    ...
    { isLoading && <Spin tip="Получаем все Виды работ..." size="large" fullscreen/>  } 

    <div className="mt-20">
      <h1>Видов работ: <strong>{data?.count}</strong> </h1>
